...
def pibooth_configure(cfg):
    ...
    cfg.add_option('OLED DISPLAY 2 SETUP', 'oled_devices', "sh1106",
    ...
    cfg.add_option('OLED DISPLAY 2 SETUP', 'oled_i2c_or_spi', "I2c",
                   "I2c or SPI display connection",
                   "I2c or SPI connection", ["SPI", "I2c"])
    cfg.add_option('OLED DISPLAY 2 SETUP', 'oled_port_address', "0x3C",
                   'I2c address 0x3C(Default)',
                   "I2c address", "0x3C")
    cfg.add_option('OLED DISPLAY 2 SETUP', 'oled_spi_device_number', "0",
                   "Change SPI device number 0 or 1 - (Default = 0)",
                   "SPI device number 0 or 1", ["0", "1"])
    cfg.add_option('OLED DISPLAY 2 SETUP', 'oled_port', "1",
                   "Change the I2c or SPI port number 0, 1 or 2 - (SPI = 0 - I2c = 1)",
                   "Port - I2c(1) or SPI(0)", ["0", "1", "2"])
    cfg.add_option('OLED DISPLAY 2 SETUP', 'oled_spi_gpio_dc_pin', "24",
                   "SPI GPIO DC PIN (24)",
                   "SPI GPIO DC PIN (24)", "24")
    cfg.add_option('OLED DISPLAY 2 SETUP', 'oled_spi_gpio_rst_pin', "25",
                   "GPIO RST PIN default(25)",
                   "GPIO RST PIN default(25)", "25")
                   # Display size    
    cfg.add_option('OLED DISPLAY 2 SETUP', 'oled_width', "128",
                   'Change screen WIDTH 128(Default)',
                   "OLED screen width", ["32", "64", "96", "128", "256"])
    cfg.add_option('OLED DISPLAY 2 SETUP', 'oled_height', "64",
                   'Change screen HEIGHT 32, 48, 64(Default), 96, 128, 256',
                   "OLED screen height", ["32", "48", "64", "96", "128", "256"])
    cfg.add_option('OLED DISPLAY 2 SETUP', 'oled_color_mode', "1",
                   'Color mode (Default = 1) RGB, RGBA',
                   "Color mode", ["1", "RGB", "RGBA"])
    cfg.add_option('OLED DISPLAY 2 SETUP', 'oled_rotate', "0",
                   'Rotate screen (Normal mode = 0 or 2)',
                   "Rotate screen", ["0", "1", "2", "3"])
                   # Logo
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_showlogo', "No",
                   "Show logo instead of text",
                   "logo instead of text", ['Yes', 'No']) # , 'Animated Gif'
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_logo_path', "/home/pi/.config/pibooth/oled_display/logo/",
                   "Pictures/Logo path")
    logo_path = cfg.get('OLED DISPLAY 2 TEXT', 'oled_logo_path').strip('"')
    _logos = sorted(os.listdir(logo_path))
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_logos', "pibooth_logo_64.png",
                   'Choose logo file',
                   "Choose logo file", _logos)
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_states_pictures', "Yes",
                   "Show state pictures",
                   "Show state pictures", ['Yes', 'No'])
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_state_picture_path', "/home/pi/.config/pibooth/oled_display/states/",
                   "state picture path")
                    # Choose Text 1, Counters 1, Date-Time 1
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_counter_type1', "Taken_Photo",
                   ...
                   # Font
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_fonts_path', "/home/pi/.config/pibooth/oled_display/fonts/",
                   "fonts path")
    fonts_path = cfg.get('OLED DISPLAY 2 TEXT', 'oled_fonts_path').strip('"')
    _fonts = sorted(os.listdir(fonts_path))
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_font_1', "DejaVuSerif-Bold.ttf",
                   'Text 1 font',
                   "Text 1 font", _fonts)
                   # Text 1 color
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text1_color', "white",
                   ...
                   # Text 1
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text_1', '"Photos  "',
                   'Text-1',
                   "Text-1", '"Photos  "')
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_size_1', "19",
                   'Text-1 size',
                   "Text-1 size", "19")
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text1_right', "0",
                   'Text-1 move right',
                   "Text-1 move right", "0")
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text1_down', "0",
                   'Text-1 move down',
                   "Text-1 move down", "0")
                    # Choose Text 2, Counters 2, Date-Time 2
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_counter_type2', "Printed",
                   ...
                   "Text-2 Counter DateTime", ['Taken_Photo', 'Printed', 'Forgotten', 'Remaining_Duplicates', 'Date-Time', 'Empty', 'Text_Only'])
                    # Font 2
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_font_2', "DejaVuSerif-Bold.ttf",
                   'Text 2 font',
                   "Text 2 font", _fonts)
                   # Text 2 color
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text2_color', "white",
                   ...
                   # Text 2
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text_2', '"Printed "',
                   'Text-2',
                   "Text-2", '"Printed "')
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_size_2', "19",
                   'Text-2 size',
                   "Text-2 size", "19")
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text2_right', "0",
                   'Text-2 move right',
                   "Text-2 move right", "0")
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text2_down', "23",
                   'Text-2 move down',
                   "Text-2 move down", "23")
                    # Choose Text 3, Counters 3, Date-Time 3
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_counter_type3', "Remaining_Duplicates",
                   ...
                   "Text-3 Counter DateTime", ['Taken_Photo', 'Printed', 'Forgotten', 'Remaining_Duplicates', 'Date-Time', 'Empty', 'Text_Only'])
                    # Font 3
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_font_3', "DejaVuSerif-Bold.ttf",
                   'Text 3 font',
                   "Text 3 font", _fonts)
                   # Text 3 color
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text3_color', "white",
                   ...
                   # Text 3
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text_3', '"Remain "',
                   'Text-3',
                   "Text-3", '"Remain "')
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_size_3', "19",
                   'Text-3 size',
                   "Text-3 size", "19")
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text3_right', "0",
                   'Text-3 move right',
                   "Text-3 move right", "0")
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text3_down', "46",
                   'Text-3 move down',
                   "Text-3 move down", "46")
                    # Choose Text 4, Counters 4, Date-Time 4
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_counter_type4', "Empty",
                   ...
                   "Text-4 Counter DateTime", ['Taken_Photo', 'Printed', 'Forgotten', 'Remaining_Duplicates', 'Date-Time', 'Empty', 'Text_Only'])
                    # Font 4
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_font_4', "DejaVuSerif-Bold.ttf",
                   'Text 4 font',
                   "Text 4 font", _fonts)
                   # Text 4 color
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text4_color', "white",
                   ...
                   # Text 4
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text_4', '"Text 4"',
                   'Text-4',
                   "Text-4", '"Text 4"')
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_size_4', "19",
                   'Text-4 size',
                   "Text-4 size", "19")
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text4_right', "0",
                   'Text-4 move right',
                   "Text-4 move right", "0")
    cfg.add_option('OLED DISPLAY 2 TEXT', 'oled_text4_down', "0",
                   'Text-4 move down',
                   "Text-4 move down", "0")
