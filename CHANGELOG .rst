...
Version 2.0.3 (??/??/2023)
--------------------------
- Improvement: Version comparison between package and local files in '~/.config/pibooth/oled_display/' folder. Now it do an 'AutoUpdate' of the files 'Date-Time_Format_Codes.rst' and 'pibooth_oled_display_2.py' installed in the local pibooth config folder, if the files are older than the packages version.
...
- Added: New docstring for info on plugin on Pypi search.
